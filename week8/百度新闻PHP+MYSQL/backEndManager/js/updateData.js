...
function addFormDataUpdate(index) {
    ...
    $("#titleUpdate").val($(rowSelectedTd[1]).html());
    $("#newsContentUpdate").val($(rowSelectedTd[2]).html());
    $("#newsLinkUpdate").val($(rowSelectedTd[3]).html());
    $("#imgSrc0Update").val($(rowSelectedTd[4]).html());
    $("#imgSrc1Update").val($(rowSelectedTd[5]).html());
    $("#imgSrc2Update").val($(rowSelectedTd[6]).html());
    $("#srcNetUpdate").val($(rowSelectedTd[7]).html());
    $("#srcTimeUpdate").attr('value', $(rowSelectedTd[8]).html());
    $("#srcTimeUpdate").val($(rowSelectedTd[8]).html());
    $("#srcIcon0Update").val($(rowSelectedTd[9]).html());
}
...
function confirmFormDataUpdate(index) {
    ...
    $(rowSelectedTd[1]).html($("#titleUpdate").val());
    $(rowSelectedTd[2]).html($("#newsContentUpdate").val());
    $(rowSelectedTd[3]).html($("#newsLinkUpdate").val());
    $(rowSelectedTd[4]).html($("#imgSrc0Update").val());
    $(rowSelectedTd[5]).html($("#imgSrc1Update").val());
    $(rowSelectedTd[6]).html($("#imgSrc2Update").val());
    $(rowSelectedTd[7]).html($("#srcNetUpdate").val());
    $(rowSelectedTd[8]).html($("#srcTimeUpdate").val());
    $(rowSelectedTd[9]).html($("#srcIcon0Update").val());
}
//通过键值求键名
